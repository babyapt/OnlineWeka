...
$displayStdDevs = $_POST['displayStdDevs'];
$distanceFunction = $_POST['distanceFunction'];
$dontReplaceMissingValues = $_POST['dontReplaceMissingValues'];
$maxIterations = $_POST['maxIterations'];
$numClusters = $_POST['numClusters'];
$preserveInstancesOrder = $_POST['preserveInstancesOrder'];
$seed = $_POST['seed'];
...
$result = " ".$displayStdDevs." ".$dontReplaceMissingValues." "."-N"." ".$numClusters." "."-A"." \"weka.core.".$distanceFunction." -R first-last\" "."-I"." ".$maxIterations." ".$preserveInstancesOrder." "."-S"." ".$seed;
...
if(file_exists("savefile_pdf/SimpleKMeans_".$SID.".pdf"))
{
	unlink("savefile_pdf/SimpleKMeans_".$SID.".pdf");
}
if(file_exists("savefile_txt/SimpleKMeans_".$SID.".txt"))
{
	unlink("savefile_txt/SimpleKMeans_".$SID.".txt");
}
...
$cmd ="java -cp weka.jar weka.clusterers.SimpleKMeans".$result." ".$T_result." ".$File.$SID.".arff"." 2>errorcmd/".$SID.".txt";
	...
	if(sizeof($output) == 0)	
			...
			for ( $i = 0;$i<sizeof($output);$i++)
			{
				...
				file_put_contents("savefile_txt/SimpleKMeans_".$SID.".txt", $content,FILE_APPEND);
			...
			$pdf = new FPDF();	
	 		...
	 		$txt = file_get_contents("savefile_txt/SimpleKMeans_".$SID.".txt");
	 		$pdf->Write(5,$txt);
			$pdf->Output("savefile_pdf/SimpleKMeans_".$SID.".pdf","F");
...
<input name="Hidden" type="hidden" value="SimpleKMeans_">
...
<input name="Hidden2" type="hidden" value="SimpleKMeans_">	
