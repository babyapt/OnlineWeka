...
function check(){
	var num_fold = document.Logistic.Folds.value;
 var instance = "<?=$result?>";
  if(x = num_fold)
  {
  if (x > 0 && x <= instance){
...
var Percen = document.Logistic.Percen.value;
...
<div data-role="page" id="page" >
  ...
  <div data-role="content"><center><form name="Logistic" action="Logistic_para.php" method="post" onsubmit="return check()"  data-ajax="false">
...
<table width="331" height="120" border="0" align="center">
    <tr>
    <td>
...
<li data-role="list-divider" data-theme="a" data-swatch="a" data-form="ui-bar-a">ค่า พารามิเตอร์</li>    
  ...
  <tr>
    <td height="23"><p align="left">maxIts</td>
    <td><p align="left"><input name="maxIts" type="text" value="-1" size="15" /></td>
  </tr>
  <tr>
    <td height="23"><p align="left">ridge </td>
    <td><p align="left">
      <input name="ridge" type="text" value="1.0E8" size="15" />
    </td>
  </tr>
